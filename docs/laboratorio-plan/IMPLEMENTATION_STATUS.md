...
| Tarea activa | Ninguna — **Fase 4: 7 de 17**. El motor de exposición real ya tiene pantalla y una vía para alimentarlo a mano. Siguiente: identidad canónica de instrumentos (LAB-402) y adaptador de SEC EDGAR (LAB-406) |
