...
export const REASON_CODES: readonly ReasonEntry[] = [
  ...
  {
    code: 'insufficient_classification',
    severity: 'blocking',
    text: 'Una parte importante de la cartera no dice qué exposición económica representa, así que no se puede estimar su rentabilidad esperada.',
    remediation: 'Declara la clase de tus fondos y ETF, o añade su composición. El resto de carteras candidatas sí se calculan.',
    origin: 'optimización',
  },
  {
    code: 'invalid_cash_rate',
    severity: 'blocking',
    text: 'La tasa del efectivo configurada no es un valor razonable.',
    origin: 'optimización',
  },
  {
    code: 'not_positive_semidefinite',
    severity: 'blocking',
    text: 'La matriz de covarianza asigna riesgo negativo a alguna combinación de pesos, y no se arregla con una regularización razonable.',
    remediation: 'Suele significar más activos que observaciones: amplía el periodo o reduce el número de posiciones analizadas.',
    origin: 'optimización',
  },
  {
    code: 'not_symmetric',
    severity: 'blocking',
    text: 'La matriz de covarianza no es simétrica, cuando por definición lo es: sus dos mitades se han calculado por caminos distintos.',
    origin: 'optimización',
  },
  {
    code: 'not_square',
    severity: 'blocking',
    text: 'La matriz de covarianza está mal formada.',
    origin: 'optimización',
  },
  {
    code: 'nonpositive_variance',
    severity: 'blocking',
    text: 'Alguna posición no tiene varianza: su serie es constante o no tiene observaciones, y así no puede entrar en la optimización.',
    origin: 'optimización',
  },
  {
    code: 'empty_universe',
